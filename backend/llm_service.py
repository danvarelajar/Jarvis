...
def build_structured_prompt_gemma(
    ...
    prompt += "6. STEP-BY-STEP for 'checkin tomorrow and checkout on 02/01/2026':\n"
    prompt += "   STEP 1: Look in DATE CONTEXT for 'tomorrow' -> find the YYYY-MM-DD date (e.g., '2026-01-02')\n"
    prompt += "   STEP 2: Use that date for checkInDate: \"checkInDate\": \"2026-01-02\"\n"
    prompt += "   STEP 3: Look in DATE CONTEXT for '02/01/2026' -> find the YYYY-MM-DD date (e.g., '2026-02-01')\n"
    prompt += "   STEP 4: Use that date for checkOutDate: \"checkOutDate\": \"2026-02-01\"\n"
    prompt += "   STEP 5: Verify they are DIFFERENT - if same, you made an error\n"
    prompt += "7. Do NOT use the same date for both checkInDate and checkOutDate.\n"
    prompt += "8. Do NOT calculate checkout as checkin + 1 day - use the ACTUAL date from DATE CONTEXT.\n"
    prompt += "\n"
